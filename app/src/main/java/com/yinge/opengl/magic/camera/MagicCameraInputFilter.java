...
public class MagicCameraInputFilter extends GPUImageFilter{
    ...
    public MagicCameraInputFilter(Context context){
        // 顶点着色器 和 片元着色器
        super(OpenGlUtils.readShaderFromRawResource(context.getResources(), R.raw.camera_input_vertex),
                OpenGlUtils.readShaderFromRawResource(context.getResources(),R.raw.camera_input_fragment));
    }
