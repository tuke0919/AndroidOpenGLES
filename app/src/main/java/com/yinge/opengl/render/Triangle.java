...
public class Triangle extends Shape {
    ...
    public Triangle(View view) {
        ...
        // 加载并编译 顶点着色器
        String vertexShaderCode1 = OpenGlUtils.loadShaderSrcFromAssetFile(mView.getResources(), "shape/vshader" + "/vTriangle.glsl");
        int vertexShader = loadShader(GLES20.GL_VERTEX_SHADER,vertexShaderCode1);

        // 加载并编译 片元着色器
        String fragmentShaderCode1 = OpenGlUtils.loadShaderSrcFromAssetFile(mView.getResources(), "shape/fshader" + "/fTriangle.glsl");
