...
public class EGLHelper {
    ...
    public EGLHelper(int surfaceWidth, int surfaceHeight) {
    ...
    public void createEglContext() {
        ...
        // 设置 egl配置
        EGLConfigChooser eglConfigChooser = new SimpleEGLConfigChooser(8, 8, 8, 8, 0,0);
        mEglConfig = eglConfigChooser.chooseConfig(mEgl10, mEglDisplay);

        // 创建 EglSurface
        EGLSurfaceFactory eglSurfaceFactory = new SimpleEglSurfaceFactory(EGLSurfaceFactory.SURFACE_PBUFFER);
        // surface 属性
        ...
        mEglSurface = eglSurfaceFactory.createSurface(mEgl10, mEglDisplay, mEglConfig, mSurfaceNativeObj, attrList);

        // 创建 EglContext
        EGLContextFactory eglContextFactory = new SimpleEGLContextFactory();
    ...
    public class SimpleEGLConfigChooser extends BaseConfigChooser{
        ...
        public SimpleEGLConfigChooser(int[] mConfigSpec) {
            super(mConfigSpec);
        }
